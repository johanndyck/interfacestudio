...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php
			the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'interfacestudio' ), array( 'span' => array( 'class' => array() ) ) ),
	...
	<footer class="entry-footer">
		<?php interfacestudio_entry_footer(); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->
